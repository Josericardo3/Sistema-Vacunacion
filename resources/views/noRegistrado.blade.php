    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
      ...
      <div class="login-box">
        ...
        <div class="object"></div>
          ...
          <form>
            <input type="submit" formaction="area_sal.html" value="Area de Salud">
         </form>
           
          
            <br>
            <form>
            <input type="submit" formaction="fuer_arm.html" value="Fuerzas Armadas">
          </form> 
            <br>
            <form>
            <input type="submit" formaction="mayor.html" value="Mayores de 60 años">
          </form>
        </div>
