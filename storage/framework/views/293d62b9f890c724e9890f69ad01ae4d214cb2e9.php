...
<html lang="en">
  <head>
    ...
    <!--CSS-->
    <link href="<?php echo e(asset('css/styleindex.css')); ?>" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;600&display=swap" rel="stylesheet">         

    <title>Sistema Vacunacion</title>
  </head>
  <body>
      <!--NAV-->
    ...
    <section id="portada">
        <div class="container-fluid text-dark">
            ...
            <h3 class="text-dark">Sistema de vacunación covid-19 para el mes de enero 2021, comprueba tu cita registrandote en nuestro sistema.</p>
            <br>
            <a class="btn btn-primary" href="<?php echo e(url("/registro")); ?>" role="button">Iniciar</a>
            </div>
        </div>
    </section>
...
</html><?php /**PATH C:\xampp\htdocs\sistemavacunacion\resources\views/welcome.blade.php ENDPATH**/ ?>