...
<head>
    ...
    <link href="<?php echo e(asset('css/detalles.css')); ?>" rel="stylesheet">
</head>
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-12" style="height: 97vh;">
            <button class="btn btn-info m-3"><a id="enlace" href="<?php echo e(url("/")); ?>">Atrás</a></button><h3 class="text-center mb-3" style="margin: 0;
            padding: 0 0 20px;
            text-align: center;
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-8">
                        ...
                        <div class="text-center">
                            ...
                            <button type="" class="btn btn-danger rounded px-4">Cancelar cita</button>
                        </div>
                </div>
                <div class="col-md-2 col-2"></div>
            </div>
        ...
        <div class="col-md-4 col-4 derecha" style="background:#50c2ff !important; display: flex; align-items:center; height:97vh;">
...
</html><?php /**PATH C:\xampp\htdocs\sistemavacunacion\resources\views/detalles.blade.php ENDPATH**/ ?>